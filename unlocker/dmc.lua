...
--br.ListFiles = dmc.GetDirectoryFiles
...
--- Midnight Mem offsets to avoid secret values for health
br.apis["UnitHealth"] = function(unit) 
    return dmc.ObjectField(unit,0x1958,8)
end

br.apis["UnitHealthMax"] = function(unit) 
    return dmc.ObjectField(unit,0x1BB0,8)
end
